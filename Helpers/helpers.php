 ...
 * Last modified: 2021.05.27 at 18:31:49 
 * Author: ultroNeous Technologies https://ultroneous.com/
 * Copyright (c) 2021
 */

use FoodOrder\Generator\Common\GeneratorCuisine;
use FoodOrder\Generator\Utils\GeneratorCuisinesInputUtil;
use FoodOrder\Generator\Utils\HTMLCuisineGenerator;
use FoodOrder\Component\Debug\Exception\FatalThrowableError;
...
function generateCustomField($fields, $fieldsValues = null)
{
    ...
    foreach ($fields as $field) {
        ...
        $gf = new \FoodOrder\Generator\Common\GeneratorField();
        if ($fieldsValues) {
        ...
        $fieldTemplate = \FoodOrder\Generator\Utils\HTMLFieldGenerator::generateCustomFieldHTML($gf, config('FoodOrder.laravel_generator.templates', 'adminlte-templates'));
...
/**
 * Get class name by giving the full name of the class
 * Ex:
